...
/// <summary>
/// Represents the repository to manage page views.
/// </summary>
public sealed class PageViewsRepository : PostgreSqlRepository<PageViewEntity, PostgreSqlRepositoryOptions>, IPageViewsRepository
{
    /// <summary>
    ...
    /// </param>
    public PageViewsRepository(IOptions<PostgreSqlRepositoryOptions> options,
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.ToTable("page_views", Options.Schema);
