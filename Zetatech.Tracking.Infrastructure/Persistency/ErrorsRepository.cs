...
/// <summary>
/// Represents the repository to manage errors.
/// </summary>
public sealed class ErrorsRepository : PostgreSqlRepository<ErrorEntity, PostgreSqlRepositoryOptions>, IErrorsRepository
{
    /// <summary>
    ...
    /// </param>
    public ErrorsRepository(IOptions<PostgreSqlRepositoryOptions> options,
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.ToTable("errors", Options.Schema);
            entity.HasKey(x => new { x.AppId, x.Id })
                  .HasName("pk_errors");
            entity.Property(x => x.AppId)
                  .HasColumnName("app_id")
                  .IsRequired();
            entity.Property(x => x.ErrorTypeName)
                  .HasColumnName("error_type_name")
                  .HasMaxLength(128)
                  .IsRequired();
