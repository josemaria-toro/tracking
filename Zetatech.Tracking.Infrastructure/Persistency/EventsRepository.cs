...
/// <summary>
/// Represents the repository to manage events.
/// </summary>
public sealed class EventsRepository : PostgreSqlRepository<EventEntity, PostgreSqlRepositoryOptions>, IEventsRepository
{
    /// <summary>
    ...
    /// </param>
    public EventsRepository(IOptions<PostgreSqlRepositoryOptions> options,
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.ToTable("events", Options.Schema);
